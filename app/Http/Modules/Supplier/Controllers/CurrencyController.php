...
class CurrencyController extends Controller
{
    ...
    public function manageCurrencies()
    {
        ...
        return view('Supplier/Views/currency/manageCurrencies', ['allCurrencies' => $allCurrencies]);
    }
    ...
    public function addCurrency(Request $request)
    {
        ...
        return view('Supplier/Views/currency/addCurrency');
    }
    ...
    public function editCurrency(Request $request, $currencyId)
    {
        ...
        return view('Supplier/Views/currency/editCurrency', ['currencyDetails' => $currencyDetails]);
    }
