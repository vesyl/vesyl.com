    ...
    <div class="row">
        <div class="col-md-12">
            <div class="portlet light">
                ...
                <a href="/supplier/add-new-campaign" class="btn btn-success"><i
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        ...
                        <table id="available_dailyspecial"
            ...
            var handleOrders = function () {
                ...
                grid.init({
                    ...
                    dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                        ...
                        "ajax": {
                            "url": "/supplier/campaign-list-ajax-handler/manageDailyspecial"
                        },
                        "order": [
                            [0, "asc"]
