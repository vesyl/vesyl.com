                            ...
                            foreach ($array as $key => $category) {
                                if ($curParent == $category['parent_id']) {
                                    ...
                                    if ($category['group_flag'] == 1) {
                                        if (\Illuminate\Support\Facades\Session::get('fs_supplier')['id'] == $category['added_by']){
                                            echo "<li  data-jstree='{ \"opened\" : true }'><a href='/supplier/edit-feature-group/" . $category['feature_id'] . "'>" . $category['feature_name'] . "</a>";
                                        }else{
                                            echo "<li data-jstree='{ \"disabled\" : true}'><a data-toggle='tooltip' title='You can edit your category only.' href='javascript:void(0);'>". $category['feature_name']."</a>";
                                        }

                                    } else {

                                        if (\Illuminate\Support\Facades\Session::get('fs_supplier')['id'] == $category['added_by']){
                                            echo "<li  data-jstree='{ \"opened\" : true }'><a href='/supplier/edit-feature/" . $category['feature_id'] . "'>" . $category['feature_name'] . "</a>";
                                        }else{
                                            echo "<li data-jstree='{ \"disabled\" : true}'><a data-toggle='tooltip' title='You can edit your category only.' href='javascript:void(0);'>". $category['feature_name']."</a>";
                                        }
                ...
                <div class="col-md-5" align="right">
                    ...
                    <div role="group" class="btn-group ">
                        ...
                        <ul role="menu" class="dropdown-menu">
                            <li>
                                <a href="/supplier/add-feature-group"> <i class="fa fa-plus"></i>&nbsp;Add feature
                                    group </a>
                            </li>
                            <li>
                                <a href="/supplier/add-feature"> <i class="fa fa-plus"></i>&nbsp;Add feature </a>
                            </li>
                        </ul>
                    </div>
                </div>
