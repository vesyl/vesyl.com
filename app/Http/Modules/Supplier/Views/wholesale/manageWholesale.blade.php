    ...
    <div class="row">
        <div class="col-md-12">
            <div class="portlet light">
                ...
                <a href="/supplier/add-wholesale" class="btn btn-success"><i
...
@section('pagejavascripts')
    ...
    <script type="text/javascript">
            ...
            var handleOrders = function () {
                ...
                grid.init({
                    ...
                    dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                        ...
                        "ajax": {
                            "url": "/supplier/wholesale-ajax-handler/manageWholesale"
                        },
                        "order": [
                            [0, "asc"]
                ...
                grid.getTableWrapper().on('click', '.table-group-action-submit', function (e) {
                    ...
                    if (action.val() != "" && grid.getSelectedRowsCount() > 0) {
                        ...
                        grid.setAjaxParam("wholesaleId", grid.getSelectedRows());
        ...
        $(document.body).on('click', '.wholesale-status', function () {
        ...
        $(document.body).on('click', '.delete-wholesale', function () {
            var obj = $(this);
            var campaignId = $(this).attr('data-cid');
            if (confirm("Do you want to Delete Your Wholesale!") == true) {
                $.ajax({
                    url: '/supplier/flashsale-ajax-handler',
                    type: 'POST',
                    datatype: 'json',
