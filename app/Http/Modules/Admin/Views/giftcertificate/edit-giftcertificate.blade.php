                ...
                <div class="portlet-body form">
                    ...
                    <form class="form-horizontal form-bordered" id="addnewdailyspecial" enctype="multipart/form-data"
                                    ...
                                    <div class=" form-horizontal">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="gift_name"
                                                   name="gift_name" placeholder="Gift code name" value="{{$adminGiftDataById->gift_name}}">
                                        </div>
                                    ...
                                    <div class=" form-horizontal">
                                        <div class="form-group">
                                            <input type="text"
                                                   ...
                                                   value="<?php echo old('gift_code')!= '' ? old('gift_code'): $adminGiftDataById->gift_code; ?>">
                                        </div>
                                    ...
                                    <div class=" form-horizontal">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="gift_amount"
                                                   name="gift_amount" placeholder="Gift amount" value="{{$adminGiftDataById->gift_amount}}">
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail"
                                        ...
                                        @if($adminGiftDataById->gc_img_src!='')
                                            <img src="{{$adminGiftDataById->gc_img_src}}" alt=""/>
                                            <input type="hidden" name="oldImage"
                                                   value="{{$adminGiftDataById->gc_img_src}}">
                                        @else
                        ...
                        <div class="form-actions">
                            <div align="center">
                                <button type="submit" class="btn blue" type="submit" id="addsubmit">Save Gift Certificate
                                </button>
                            </div>
                        </div>
                    </form>
