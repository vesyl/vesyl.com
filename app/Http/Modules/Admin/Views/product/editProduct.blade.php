                                        ...
                                        <div class="panel panel-default panel-info">
                                            ...
                                            <div id="collapseInfo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingInfo" aria-expanded="true">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">For shop</label>
                                                                    ...
                                                                    <div class="row" align="center">
                                                                        <form enctype="multipart/form-data" class="form-horizontal form-row-seperated" id="product-main-image-form" method="post">
                                                                            ...
                                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                                ...
                                                                                <div style="position: absolute; top: -100%; right: -20%; width: 100%;">
                                                                                    <span class="btn-file" style="position: absolute; right: 375px; top: 337px;">
                                                                                        <span class="fileinput-exists fa fa-camera btn btn-circle default ">
                                                                                            Change </span>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response['code'] == 200) {
                                ...
                                bootbox.alert("Successfully updated main image!");
                            } else {
            ...
            var ProductImageUpload = function () {
                ...
                var handleImages = function () {
                    ...
                    var uploader = new plupload.Uploader({
                        ...
                        url: '/admin/edit-product/{{$productData['product_id']}}?updateFormName=otherimages',
                        filters: {
                            max_file_size: '2mb',
                            mime_types: [
