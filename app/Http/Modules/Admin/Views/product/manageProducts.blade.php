...
@section('title', 'Manage Active Products') {{--TITLE GOES HERE--}}
            ...
            <div class="panel panel-white">
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        ...
                        <table id="available_products"
                               class="display table table-striped table-bordered table-hover text-center"
                               cellspacing="0"
                               width="100%">
                            <thead>
                            ...
                            <tr role="row" class="filter">
                                <td></td>
                                <td><input type="text" class="form-control form-filter input-sm"  style="width:42px" name="product_id"></td>
                                <td></td>
                                <td>
...
@section('pagejavascripts')
    ...
    <script type="text/javascript">
            ...
            var handleOrders = function () {
                ...
                grid.init({
                    ...
                    dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                        ...
                        "ajax": {
                            "url": "/admin/product-list-ajax-handler/manageProducts"
                        },
                        "order": [
                            [0, "asc"]
        ...
        $(document).ready(function () {
            ...
            $(document.body).on("click", ".product-status", function () {
            ...
            $(document.body).on('click', '.delete-product', function () {
                var obj = $(this);
                var productId = $(this).attr('data-cid');
                var status = 4;
                $.ajax({
                    url: '/admin/product-ajax-handler',
                    type: 'POST',
