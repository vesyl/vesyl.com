        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="/admin/manage-campaign" class="btn btn-default btn-circle"><i
                    ...
                    <form class="form-horizontal form-bordered" id="addnewdailyspecial" enctype="multipart/form-data"
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group col-md-6">
                                <label class="control-label col-md-4 col-lg-4 col-sm-4 col-xs-12">Upload Banner:</label>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            @if($dailyspecialInfo->campaign_banner!='')
                                                ...
                                                <input type="hidden" name="oldImage" value="{{$dailyspecialInfo->campaign_banner}}">
                                            @else
                                        ...
                                        <div>
                                            <span class="btn btn-circle default btn-file">
                                                ...
                                                <span class="fileinput-exists">
                                                    Change </span>
                                                <input type="file" name="dailyspecial_image" accept="image/*">
                                            </span>
                                            <a href="#" class="btn btn-circle default fileinput-exists" data-dismiss="fileinput">
                                                Remove </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                <label class="control-label col-md-4 col-lg-4 col-sm-4 col-xs-12">Secondary
                                    banner:</label>
                                ...
                                <div class="input-group">
                                    <div class=" form-horizontal">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                @if($dailyspecialInfo->campaign_sec_banner != '')
                                                    <img src="{{$dailyspecialInfo->campaign_sec_banner}}" alt=""/>
                                                    <input type="hidden" name="oldImage" value="{{$dailyspecialInfo->campaign_sec_banner}}">
                                                @else
                                                    <img src="/assets/images/no-image.png" alt=""/>
                                                @endif
                                            </div>
                                            ...
                                            <div>
                                                <span class="btn btn-circle default btn-file">
                                                    ...
                                                    <span class="fileinput-exists">
                                                        Change </span>
                                                    <input type="file" name="campaign_sec_banner"
                                                            accept="image/*">
                                                </span>
                                        ...
                                        {!!  $errors->first('campaign_sec_banner', '<font color="red">:message</font>') !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2 col-lg-2 col-sm-2 col-xs-12">Logo:</label>

                                <div class="input-group">
                                    <div class=" form-horizontal">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                @if($dailyspecialInfo->campaign_logo != '')
                                                    <img src="{{$dailyspecialInfo->campaign_logo}}" alt=""/>
                                                    <input type="hidden" name="oldImage" value="{{$dailyspecialInfo->campaign_logo}}">
                                                @else
                                                    <img src="/assets/images/no-image.png" alt=""/>
                                                @endif
                                            </div>
                                        ...
                                        {!!  $errors->first('campaign_logo', '<font color="red">:message</font>') !!}
                                    </div>
                                </div>
                            </div>
