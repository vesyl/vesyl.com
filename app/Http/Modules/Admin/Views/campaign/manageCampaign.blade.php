...
@section('title', 'Manage Campaign') {{--TITLE GOES HERE--}}
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green-sharp bold uppercase">All Campaigns</span>
                    </div>

                </div>
                <a href="/admin/add-new-campaign" class="btn btn-success"><i
                            class="fa fa-plus "></i>&nbsp; Add New Campaign
                </a>
                    ...
                    <div class="table-container">
                        ...
                        <table id="available_campaign"
                            ...
                            <tr role="row" class="filter">
                                ...
                                <td>
                                    <select name="campaign_type" class="form-control form-filter input-sm">
                                        <option value="">Select...</option>
                                ...
                                <td>
                                    ...
                                    <div class="input-group date form_datetime input-small">
                                        <input id="availablefromdate" name="available_from_date" type="text"
                                    ...
                                    {{--<div class="input-group margin-bottom-5">--}}
                                    {{--<input type="text" class="form-control form-filter input-sm"--}}
                                    {{--name="available_from_date" placeholder="From">--}}
                                    {{--</div>--}}
                                </td>
                                <td>
                                    {{--<div class="col-md-4">--}}
                                    <div class="input-group date form_datetime input-small">
                                        ...
                                        <input id="availableuptodate" name="available_upto_date" type="text"
                                               class="form-control form-filter input-sm">
                                            <span class="input-group-btn">
                                                {{--<button type="button" class="btn default date-reset"><i--}}
                                                            {{--class="fa fa-times"></i></button>--}}
                                    ...
                                    {{--<div class="input-group margin-bottom-5">--}}
                                    {{--<input type="text" class="form-control form-filter input-sm"--}}
                                    {{--name="available_upto_date" placeholder="Upto">--}}
                                    {{--</div>--}}
                                </td>
                                {{--<td></td>--}}
                                {{--<td>--}}
...
@section('pagejavascripts')
    ...
    <script>
        ...
        //            $('#available_dailyspecial').DataTable({
        //                "processing": true,
        //                "serverSide": true,
        //                "ajax": {
        //                    url: "/supplier/dailyspecial-ajax-handler",
        //                    data: {
        //                        method: 'manageDailyspecial'
        //                    },
        //                },
        ...
        //            });
        $(document).ready(function () {
            $(document.body).on("click", ".extend-type", function () {

                var campaignId = $(this).attr('data-campaignId');
                var availableUpto = $(this).attr('data-availableUpto');
                var extenddays = '';
                extenddays = $('#extendDays' + campaignId).val();
                if (extenddays != '' && extenddays != null) {

                } else {
                    alert('Please Enter Extended Days For Submit');
                }
                $.ajax({
                    ...
                    datatype: 'json',
                    data: {
                        method: 'updateExtendedDaysForCamapign',
...
//                var append = '';
//                append = '<input type="text"  value="" name="extended" class="bgtrans pull-left edittype">';
//                $(this).find('input').val('');
//                $(this).closest('.trclass').find('.save').removeClass('hidden');
//                $(this).closest('.trclass').find('.edittype').removeClass('hidden');
            });
            ...
            var handleOrders = function () {
                ...
                grid.init({
                    ...
                    dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                        ...
                        "ajax": {
                            "url": "/admin/campaign-list-ajax-handler/manageCampaign"
                        },
                        "order": [
                            [0, "asc"]
                ...
                grid.getTableWrapper().on('click', '.table-group-action-submit', function (e) {
                    ...
                    if (action.val() != "" && grid.getSelectedRowsCount() > 0) {
                        ...
                        grid.setAjaxParam("campaignId", grid.getSelectedRows());
        ...
        $(document.body).on('click', '.dailyspecial-status', function () {
        ...
        $(document.body).on('click', '.delete-dailyspecial', function () {
            var obj = $(this);
            var campaignId = $(this).attr('data-cid');
            if (confirm("Do you want to Delete Your Dailyspecial!") == true) {
                $.ajax({
                    url: '/supplier/flashsale-ajax-handler',
                    type: 'POST',
                    datatype: 'json',
