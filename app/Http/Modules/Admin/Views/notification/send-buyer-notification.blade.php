...
@section('title', 'Send Buyer Notification') {{--TITLE GOES HERE--}}
                ...
                <div class="panel-body">
                    ...
                    <div style="overflow-x:auto;height:500px;">
                        <table class="dynamicTable table table-striped table-bordered table-condensed" id="subjecttable"  >
                            ...
                            <?php
                            if (isset($buyerDetails) && !empty($buyerDetails)) {
                            $row = 0;
                            foreach ($buyerDetails as $collectionData) {     // echo '<pre>';print_r($collectionData);die;
                            ?>
                            <tr class="selectable">
                                <td ><?php echo ++$row; ?></td>
