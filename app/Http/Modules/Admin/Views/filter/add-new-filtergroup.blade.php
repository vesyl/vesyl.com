        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <form class="form form-horizontal" id="addnewfiltergroupform" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <select class="form-control filtergroup hide" id="productFilterGroups"
                                    ...
                                    <?php if(isset($allGroupFilter) && !empty($allGroupFilter)){ foreach($allGroupFilter as $key => $val) { ?>
                    ...
                    <button type="submit" class="btn btn-info btn-rounded hide" id="submitadd" style="text-align:center">
                        Add filter group
                    </button>
