        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <table id="orderstableadmin" class="display table table-striped table-bordered table-hover text-center" cellspacing="0" width="100%">
                        <thead>
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <select name="order_status" class="form-control form-filter input-small">
                                    ...
                                    <option value="TP">Payment Pending</option>
                                    <option value="S">Shipping</option>
                                    <option value="D">Delivered</option>
                                    <option value="UC">User cancel request</option>
                                    <option value="UCA">User cancel approved</option>
                                    <option value="RR">Refund request</option>
                                    <option value="RP">Refund in process</option>
                                    <option value="RD">Refund done</option>
                                    <option value="MC">Merchant cancel</option>
                                </select>
                            </td>
                            <td>
            ...
            var handleOrders = function () {
                ...
                grid.init({
                    ...
                    dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                        ...
                        "ajax": {
                            "url": "/admin/order-datatables-handler?tablename=orderstableadmin"
                        },
                        "order": [
                            [0, "asc"]
