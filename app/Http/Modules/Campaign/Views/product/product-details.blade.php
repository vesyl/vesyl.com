        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-md-7 qdsec_right">
                    <div class="row xy_tshirt">
                        <div class="col-md-6 t_shirt">
                            ...
                            <div class="reviews">
                                ...
                                <a href="javascript:;" onclick="$('#tab_1_4_1').click();$('html, body').animate({ scrollTop: $('#tab_1_4_1').offset().top }, 'slow');">Add Your Review</a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="pul-right">
                    ...
                    @if(!empty($productdetails[0]['options']))
                            ...
                            @foreach($productdetails[0]['options'] as $optionKey => $optionVal)
                                <div class="col-md-6 option">
                                    ...
                                    @foreach($optionVal['variantData']['variant_id']  as $variantKey => $variantVal)
                                        <div prod-id="{{$productdetails[0]['product_id']}}" data-id="{{$optionVal['variantData']['variant_id'][$variantKey]}}" pricemodifier="{{$optionVal['variantData']['price_modifier'][$variantKey]}}" value="{{$optionVal['variantData']['variant_id'][$variantKey]}}" option-id="{{$optionVal['option_id']}}" variant-id="{{$optionVal['variantData']['variant_id'][$variantKey]}}" class="size option-variant">{{$optionVal['variantData']['variant_name'][$variantKey]}} </div>
                                    @endforeach
                                </div>
                            @endforeach
                        </div>
                    ...
                    @if(isset($productdetails[0]['quantity_discount']) && $productdetails[0]['quantity_discount'] != '')
                        ...
                        @endforeach
                        @if($qVal->quantity != null && $qVal->value != null && $qVal->type != null)
                                    ...
                                    @foreach(json_decode($productdetails[0]['quantity_discount']) as $qKey => $qVal)
                                        @if($qVal->quantity != null && $qVal->value != null && $qVal->type != null)
                                            <tr>
                                                <td>{{$qVal->quantity}}</td>
                                                <td>
                                                    <span>{{$qVal->value}}</span>{{($qVal->type) ? '%' : '$'}}</span>
                                                </td>
                                            </tr>
                                        @endif
                                    @endforeach
                    ...
                    <div class="row add-cart">
                        <div class="col-md-2 col-xs-2 col-sm-3">
                            ...
                            <div class="form-group width-100">
                                ...
                                <input min="0" id="input-item-count" class="form-control quantity" type="text" style="padding:0; text-align:center; width:50px;margin-left: 6px;" name="input-item-count">
                        ...
                        <div class="col-md-10">
                            <div class="row buy_button">
                                <a class="btn btn-primary btn-lg brdr_non pading_lr top15_margin cartOptions" href="javascript:;" role="button">ADD
                                    TO CART</a>
                                ...
                                @if(isset($productdetails[0]['product_tabs']))
                                    ...
                                    @if($mainDesc->description == 1)
                                        @if(isset($productdetails[0]['product_full_description']) && !empty($productdetails[0]['product_full_description']))
                                            <li class="active"><a href="#tab_1_1" data-toggle="tab">Description</a></li>
                                        @endif
                                    @endif
                                    ...
                                    @if($mainDesc->reviews == 1)
                                        <li><a href="#tab_1_4" data-toggle="tab" id="tab_1_4_1">Reviews</a></li>
                                    @endif
                                @endif
                            </ul>
                        </div>
                                            ...
                                            <div class="panel-heading" role="tab" id="headingInfo">
                                                ...
                                                <div id="review_details">
                                                    ...
                                                    <div id="writenewreview">
                                                        ...
                                                        <p>Now please write a (short) review....(min. 200, max. 2000
                                                            characters)</p>
                                                        <textarea id="review_description" name="review_textarea"></textarea>
                                                        <span class="success_error1"></span>
                                                        <br>
                                                        <div class="stars">
                                                    ...
                                                    <button id="seemore" class="btn btn-primary col-md-8 col-sm-offset-2 " style="margin-top:15px;" data-id="@if(isset($productdetails[0]))
                                                    {{$productdetails[0]['product_id']}} @endif">See more
                                                    </button>
                                                    </div>                                                </div>
                                            </div>
                                        </div>
...
@section('pagejavascripts')
    ...
    <script type="text/javascript">
        ...
        $(window).on("load", function () {
            ...
            actualResponse['variant_ids_combination'] = "<?php echo $productdetails[0]['variant_ids_combination']; ?>"
        ...
        $("#seemore").click(function () {
            ...
            $.ajax({
                ...
                success: function (result) {
                    var data = result['productreviewDetail'];
                    var rating = result['avreagedetails'];
                    ...
                    if(star){
                        $('.st_reviews').html(star);
                    }
                    if(total_count){
                        $('.review.count').html(total_count + " Reviews");
                    }
                        console.log('star')
                        console.log(star)

                        result = result.review_details;
                    ...
                    success: function (response) {
                        ...
                        if (response.code == 200) {
                            if (response.data == true) {
                                console.log("true")
                                $('#appenderror').html('<h3 style="float:left;position:relative;left:35%;color:green">Thank you for your valuable feedback.</h3><br><br>');
                                $("#writenewreview").addClass('hidden');
                                $("#review_description").val("");
                            } else {
                                console.log("false")
                                $('#appenderror').html('<h3 style="float:left;position:relative;left:35%;color:red">Waiting For Approval</h3><br><br>');
                                $("#writenewreview").addClass('hidden');
                                $("#review_description").val("");
                            }
