...
@section('title', 'Wholesales available')
...
@section('pageheadcontent')
    ...
    <style>
        ...
        ._women_men_image > img, ._section_middle img {
            width: 100%;
            border-radius: 5px;
...
@section('content')
    ...
    <div class="panel info-box panel-white">
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    @if($wholesaleList['code'] == 200)
                        @if(!(empty($wholesaleList['data'])))
                            @foreach($wholesaleList['data'] as $keyWholesale => $valueWholesale)
                                <div class="col-md-3 sub_item">
                                    <div class="_section_middle item-2">
                                        <a href="/buyer/wholesale/{{$valueWholesale['campaign_id']}}/products">
                                            <img src="{{$valueWholesale['campaign_banner']}}" alt="">
                                        </a>
                                        <div class="hidden_content">
                                            <div class="col-md-12 _hidden_wrapper padding_0">
                                                <span class="_delivery_image">
                                                    {{$valueWholesale['campaign_name']}}
                                                </span>
                                                ...
                                                {{--<span class="_delivery_text">Valid till<br> products last</span>--}}
                                                {{--</span>--}}
                                                {{--</div>--}}
                                            </div>
