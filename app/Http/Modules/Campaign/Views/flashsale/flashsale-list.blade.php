...
@section('content')
    <div class="container-fluid hero_bg" style="padding: 0"><img style="width: 100%; height:auto"
                src="@if(isset($flashsaledetails) && (!empty($flashsaledetails))){{$flashsaledetails['campaign_banner']}} @else /assets/images/hero_bg.png @endif">
    </div>
...
//                                        $('.prod_main').empty();
                                ...
                                $.each(response['product_info'], function (index, val) {
                                    ...
                                    appendProduct += '<span class="ib_textsalecate">' + val['product_name'] + '<br> $' + val['price_total'] + /* '<del> £ 100.90</del> <br> <i class="offer_percent">15% off</i>'*/ '</span>';
                                    appendProduct += '</span>';
