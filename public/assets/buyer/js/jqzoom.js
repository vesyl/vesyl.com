;(function($){
	$.fn.zoom = function(options){
		...
		var _option = {
			...
			thumb_image_width: 330,		// 当前展示图片的宽//increased by 10%
			thumb_image_height: 440,	// 当前展示图片的高//increased by 10%
			source_image_width: 990,  	// 放大图片的宽//increased by 10%
			source_image_height: 1320,	// 放大图片的高//increased by 10%
